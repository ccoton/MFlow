...
{
    public class when_suggesting_for_a_model_without_errors : given.a_login_view_model_without_errors
    {
        ...
        It should_have_two_suggestions = () => { results.Count.ShouldEqual(0); };
    }
}
