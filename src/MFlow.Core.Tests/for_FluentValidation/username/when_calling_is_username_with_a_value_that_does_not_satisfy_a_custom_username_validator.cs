...
{
    public class when_calling_is_username_with_a_value_that_does_not_satisfy_a_custom_username_validator : given.a_fluent_user_validator_with_custom_implementation_set_to_replace
    {

        Because of = () =>
        {
            user.Username = "doesnotmatchcustomusernamevalidator";
