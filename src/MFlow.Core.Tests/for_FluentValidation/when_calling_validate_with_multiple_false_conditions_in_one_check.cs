...
{
    public class when_calling_validate_with_multiple_false_conditions_in_one_check : given.a_fluent_user_validator_with_multiple_false_conditions_in_one_check
    {
