...
{
    public class when_calling_all_with_a_value_that_satisfies_a_custom_all_validator : given.a_fluent_user_validator_with_custom_implementation_set_to_replace
    {
