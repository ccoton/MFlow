...
{
    public class when_calling_all_with_collection_not_containing_all_items : given.a_fluent_user_validator_with_all_users_not_in_collection
    {
        Because of = () =>
            {
                var users = new List<User>();
                validator.Check(u => u.Users).All(users);
            };
