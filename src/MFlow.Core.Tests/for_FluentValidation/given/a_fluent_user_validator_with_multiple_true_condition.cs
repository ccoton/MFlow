...
namespace MFlow.Core.Tests.for_FluentValidation.given
{
    ...
    public class a_fluent_user_validator_with_multiple_true_conditions
    {
        ...
        Establish context = () =>
        {
            ...
            validator.Check(u => u.Password).IsEqualTo("testing").Check(u=>u.ConfirmPassword).IsEqualTo("testing");
        };
    }
}
