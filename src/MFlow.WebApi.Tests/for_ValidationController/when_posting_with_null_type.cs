...
{
    public class when_posting_with_null_type : given.a_validation_controller
    {
        static Exception exception = null;

        Because of = () => { exception = Catch.Exception(() => { validation_controller.Post(new ModelToValidate() { Validate = new object(), Type = null }); }); };
