...
using MFlow.Loaders.Xml.Tests.for_XmlValidationLoader.given;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;

namespace MFlow.Loaders.Xml.Tests.for_XmlValidationLoader
{
    public class when_loading : given.an_xml_validation_loader
    {
        static IFluentConditions<User> validation;

        Because of = () =>
        {
            validation = (IFluentConditions<User>)validation_loader.Load<User>(new User(), @"for_XmlValidationLoader\given\an_xml_validation_configuration.xml");
        };
