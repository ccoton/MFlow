...
{
    public class when_posting_with_null_type : given.a_suggestion_controller
    {
        static Exception exception = null;

        Because of = () => { exception = Catch.Exception(() => { suggestion_controller.Post(new ModelToValidate() { Validate = new object(), Type = null }); }); };
