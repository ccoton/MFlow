...
{
    public class when_posting_with_null_to_validate : given.a_validation_controller
    {
        static Exception exception = null;

        Because of = () => { exception = Catch.Exception(() => { validation_controller.Post(new ModelToValidate() { Validate = null }); }); };
